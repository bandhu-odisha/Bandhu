...
urlpatterns = [
    ...
    path('detail/<str:slug>/upload-invitation/', views.upload_ankurayan_invitation, name="UploadAnkurayanInvitation"),
    path('detail/<str:slug>/delete-invitation/', views.delete_ankurayan_invitation, name="DeleteAnkurayanInvitation"),
