...
class Ashram(InitiativeHomePageMixin, models.Model):
    ...
    class Meta:
        verbose_name = 'Odisha Satabdi Sevavrata'
        verbose_name_plural = 'Odisha Satabdi Sevavrata'
...
class Event(models.Model):
    ...
    description = models.TextField(max_length=1000)
    thumb = models.ImageField(upload_to='sevavrata/events')
...
class Meeting(models.Model):
    ...
    minutes = models.FileField(upload_to='sevavrata/meeting/%Y-%m-%d')
...
class Attendee(models.Model):
    ...
    profile = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name='sevavrata_attendees',
    )
...
def picture_upload_path(instance, filname):
    return f'sevavrata/{instance.ashram.name}/{filename}'

class Photo(models.Model):
    ashram = models.ForeignKey(Ashram, on_delete=models.CASCADE)
    picture = models.ImageField(upload_to='sevavrata/')
...
class AshramReportFile(models.Model):
    ...
    file = models.FileField(upload_to='sevavrata/reports/%Y')
...
class AshramInvitationLetter(models.Model):
    ...
    file = models.FileField(
        upload_to='sevavrata/invitation_letters/',
...
class HomeGalleryPhoto(models.Model):
    picture = models.ImageField(upload_to='sevavrata/home_gallery/')
...
class HomePage(InitiativeHomePageMixin, models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'Odisha Satabdi Sevavrata Home Page'

    def __str__(self):
        return 'Odisha Satabdi Sevavrata Home Page Content'
