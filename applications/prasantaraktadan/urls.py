...
app_name = 'prasantaraktadan'
urlpatterns = [
    path('', views.index, name="prasantaraktadan"),
    ...
    path('admin_approval/', views.admin_approval,name="ImageAdminApprovalPrasantaraktadan"),
    path('create/event/',views.create_event,name="CreateEventPrasantaraktadan")
]
