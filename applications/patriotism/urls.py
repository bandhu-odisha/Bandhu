...
app_name = 'patriotism'
urlpatterns = [
    path('', views.index, name="patriotism"),
    ...
    path('admin_approval/', views.admin_approval,name="ImageAdminApprovalPatriotism"),
    path('create/event/',views.create_event,name="CreateEventPatriotism")
]
