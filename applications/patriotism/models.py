...
class Attendee(models.Model):
    ...
    profile = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name='patriotism_attendees',
    )
...
def picture_upload_path(instance, filname):
    return f'patriotism/{instance.ashram.name}/{filename}'
...
class AshramInvitationLetter(models.Model):
    ...
    file = models.FileField(
        upload_to='patriotism/invitation_letters/',
...
class HomeGalleryPhoto(models.Model):
    picture = models.ImageField(upload_to='patriotism/home_gallery/')
...
class HomePage(models.Model):
    ...
    def __str__(self):
        return 'Patriotism in Action Home Page Content'
